...
const App = () => {
  ...
  const getStyleFeedback = async () => {
    ...
    try {
      ...
      // Access the API key from environment variables (Vite's method)
  ...
  return (
    <div className="min-h-screen-wrapper">
        ...
        >
          {isLoading ? (
            <div className="loading-spinner-container">
              <svg className="spinner" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
      ...
      {/* Attribution */}
      <div style={{
        marginTop: '2rem', /* equivalent to mt-8 or mt-10 */
        textAlign: 'center',
        color: 'rgba(255, 255, 255, 0.8)', /* slightly transparent white */
        fontSize: '0.875rem', /* text-sm */
        fontWeight: '500', /* font-medium */
        textShadow: '0 1px 2px rgba(0,0,0,0.2)', /* subtle shadow for readability */
        zIndex: 5, /* ensure it's above blobs but below main card */
        position: 'relative' /* for z-index to work */
      }}>
        Made with 🧠 by Surya Narayan S and inspired by CS50
      </div>
    </div>
  );
};
